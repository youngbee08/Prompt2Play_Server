...
const sendEmailVerification = (userName, email, token) =>{
    ...
    const emailTemplate = {
        ...
        html: `
            <div style="max-width:600px; margin:30px auto; padding:20px; background:#ffffff; border-radius:12px; box-shadow:0 10px 30px rgba(0,0,0,0.08); font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                ...
                <h1 style="color:#2c3e50; font-size:24px; margin-top:20px; font-weight:600;">Verify Your Email</h1>
                </div>
                ...
                <p style="font-size:16px; color:#555; margin-bottom:20px;">
                    Welcome to <span style="font-weight:bold; color:#2c3e50;">${appName}</span>! We're excited to have you on board.
                </p>
                <p style="font-size:16px; color:#555; margin-bottom:20px;">
                ...
                <!-- Verification Button -->
                <a href="${clientDomain}/verify/${token}" style="display:inline-block; padding:14px 28px; background:linear-gradient(135deg, #1e3c72, #2a5298); color:#ffffff !important; text-decoration:none; border-radius:50px; font-weight:600; font-size:16px; margin:25px 0; transition:all 0.3s ease; box-shadow:0 4px 15px rgba(30,60,114,0.3);">
                    Verify My Email
                </a>
                ...
                <p style="font-size:16px; color:#555;">
                    Note: This link will expire in <span style="font-weight:bold; color:#2c3e50;">5 minutes</span> for security reasons.
                </p>
                </div>
    ...
    transporter.sendMail(emailTemplate, (err,info)=>{
        if (err) {
            ...
            cosole.log("Verification Mail Sent Successfully")
        }
    });
};
